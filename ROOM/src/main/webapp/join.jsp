			...
			<div class="jumbotron" style="padding-top: 20px;">
				<form method="post" action="joinAction.jsp">
					...
					<div class="form-group" style="text-align: center;">
						<div class="btn-group" data-toggle="buttons">
							<label class="btn btn-primary active">
								<input type="radio" name="userIdentity" autocomplete="off" value="1" checked>세입자
							</label>
							<label class="btn btn-primary">
								<input type="radio" name="userIdentity" autocomplete="off" value="2" checked>관리자
							</label>
						</div>
					</div>
					<div class="form-group">
						<input type="text" class="form-control" placeholder="address" name="userAddress" maxlength="150">
					</div>
