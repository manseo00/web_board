...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<a href="bbs.jsp" class="btn btn-primary" style="background-color: black;" >LIST</a>
			<!-- 해당 글의 작성자가 본인이라면 수정과 삭제가 가능하도록 코드 추가 -->
			<%
				if(userID != null && userID.equals(bbs.getUserID())){
			%>
					<a href="update.jsp?bbsID=<%= bbsID %>" class="btn btn-primary" style="background-color: black;">UPDATE</a>
					<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="deleteAction.jsp?bbsID=<%= bbsID %>" class="btn btn-primary" style="background-color: black;">DELETE</a>
			<%
				}
			%>
		</div>
